...
class PageRoutes {
  ...
  static Map<String, Widget> _childrenCelebrationsRoutes = <String, Widget>{
    'От 2 до 15 чел.': PriceScreen(
      ...
      additionalInfo:
          'Доп.информация:\nСтоимость тематического праздника составляет: 2000 ₽'
          '\nПосле окончания спортивного праздника можно арнедовать бар(2400 ₽/ч.) и один зал(1000 ₽/ч.)',
      price: 600,
      pricePostfix: '₽/чел.',
    ),
            ...
            'Спортивная подготовка': NavigationScreen(
              ...
              cardsInfo: <String, Widget>{
                'Разовое посещение': PriceScreen(
                  ...
                  price: 500, // TODO тут плохо видна цена
                  pricePostfix: '₽/ч.',
                ),
            ...
            'По карте "Премиум"': NavigationScreen(
              ...
              cardsInfo: <String, Widget>{
                ...
                'По абонементу': PriceScreen(
                  ...
                  //TODO добавить людское объяснение что надо купить абонемент
                  pricePrefix: 'Стоимость по карте "Премиум":',
                  price: 500,
                  pricePostfix: '₽',
                ),
    ...
    'Аренда зала': NavigationScreen(
      ...
      cardsInfo: <String, Widget>{
        'Большой зал': PriceScreen(
          serviceName: 'Аренда большого зала для гиманстики',
          price: 2500,
          pricePostfix: '₽/ч.',
        ),
          ...
          cardsInfo: <String, Widget>{
            ...
            'Дети 5-14 лет': NavigationScreen(
              ...
              cardsInfo: <String, Widget>{
                'Разово': PriceScreen(
                  serviceName:
                      'Разовое посещение бассейна после 16:00 для детей 5-14 лет',
                  price: 280,
                  pricePostfix: '₽',
                ),
                'По карте "Скала"': PriceScreen(
